...
echo "  4. ${GREEN}✓${NC} POST   /api/chats/create-chat                - Test RAG (Question 1)"
echo "  5. ${GREEN}✓${NC} POST   /api/chats/create-chat                - Test RAG (Question 2)"
echo "  6. ${GREEN}✓${NC} POST   /api/chats/create-chat                - Test Function Calling (Handoff)"
echo "  7. ${GREEN}✓${NC} POST   /api/chats/create-chat                - Test Function Calling (Link)"
echo "  8. ${GREEN}✓${NC} POST   /api/chats/create-chat                - Test Function Calling (Email)"
echo "  9. ${GREEN}✓${NC} GET    /api/chats/history/{thread_id}         - Get Chat History"
